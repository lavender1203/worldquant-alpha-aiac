...
# Import all routers
from backend.routers import dashboard, tasks, alphas, knowledge, config, datasets, operators, runs, hitl
...
app.include_router(hitl.router, prefix=settings.API_V1_STR)  # Human-in-the-Loop
